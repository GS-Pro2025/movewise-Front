    ...
    >
      <View style={{ flex: 1, backgroundColor: isDarkMode ? '#112A4A' : '#FFFFFF' }}>
        <KeyboardAwareView style={{ flex: 1 }}>
          {/* Envolver hijos en una única vista principal */}
          <ScrollView
          ...
          >
            ...
            <ThemedView style={{ padding: 16, flex: 1, backgroundColor: isDarkMode ? '#112A4A' : '#FFFFFF' }}>
              ...
              <View style={styles.inputContainer}>
                ...
                <DateTimePickerModal
                  ...
                  onConfirm={(selectedDate) => {
                    ...
                    setDate(selectedDate.toISOString().split('T')[0]); // Formatear fecha a YYYY-MM-DD
                  }}
              ...
              <View style={styles.inputContainer}>
                ...
                <Text style={[styles.label, { color: isDarkMode ? '#FFFFFF' : '#0458AB' }]}>
                  {t("customer_name")} <Text style={{ color: '#FF0000' }}>(*)</Text>
                </Text>
                <TextInput
              ...
              <View style={styles.buttonContainer}>
                ...
                >
                  <Text style={[styles.saveButtonText, { color: isDarkMode ? '#0458AB' : '#FFFFFF' }]}>
                    {isLoading ? t("saving") : t("save_button")}
                  </Text>
                </TouchableOpacity>
              </View>
            </ThemedView>
