        ...
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1 }}>
          ...
          >
            <View style={styles.header}>
              ...
              <Text style={styles.textLarge}>Edit Order</Text>
            </View>
            ...
            <ThemedView style={styles.container}>
              ...
              <TouchableOpacity
                onPress={() => router.push('/modals/EditOperator')}
                style={{ flexDirection: 'row', alignItems: 'center', marginTop: 20 }}
                >
                <MaterialIcons name="person" size={24} color={colorScheme === 'dark' ? '#ffffff' : '#0458AB'} />
               <Text style={{ marginLeft: 8, color: colorScheme === 'dark' ? '#ffffff' : '#0458AB', fontWeight: '500', fontSize: 16 }}>
                Edit Operators
               </Text>
              </TouchableOpacity>
